...
import static com.example.rovermore.googlebooks.BookActivity.LOG_TAG;
import static com.example.rovermore.googlebooks.BookActivity.URL_BOOKS_REQUEST;
...
public final class QueryUtils {
    ...
    public static ArrayList<Book> extractBooks (String jSonString) throws JSONException{
        ...
        for(int i=0;i<jsonArrayBookList.length();i++){
            ...
            Book book = new Book(authors,title,yearB);
